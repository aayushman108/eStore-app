...
const Review = ({data}) => {
  return (
    <div>
      <div className='container' style={{marginTop:"2em", marginBottom:"1em", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)", height:"auto", width:"330px", padding:"1.5em"}}>
