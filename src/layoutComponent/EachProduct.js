...
const EachProduct = ({product, onClick}) => {
  ...
  return (
    <div className="mx-2 each-product-container">
      <NavLink to={`/products/${product.id}`}><img src={product.image} className="each-product-image" style={{}} onClick={onClick} alt="..." /></NavLink>
      <div className='card-feature'>
        ...
        <NavLink to={`/products/${product.id}`}><div className='card-feature-item' onClick={onClick}><i class="bi bi-eye"></i></div></NavLink>
      </div>
